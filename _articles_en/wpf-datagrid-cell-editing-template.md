...
- When the editing control is written by hand in `CellEditingTemplate`, `Validation.ErrorTemplate` can be set on it as usual, so validation errors appear inside the cell being edited.
