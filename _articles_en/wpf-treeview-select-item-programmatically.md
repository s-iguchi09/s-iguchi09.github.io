...
<figure class="article-figure">
  <img src="/images/articles/wpf-treeview-select-item-programmatically/treeview-selection-facts.svg" alt="A table measuring TreeView selection and container generation. SelectedItemProperty.ReadOnly is True, an external SetValue throws InvalidOperationException, the child container is null before expansion and a TreeViewItem once IsExpanded is set, and setting the child IsSelected makes TreeView.SelectedItem that item." width="767" height="230" loading="lazy">
