...
<figure class="article-figure article-figure--wide">
  <img src="/images/articles/wpf-textbox-updatesource-from-view-pitfalls/updatesource-pitfall-matrix.svg" alt="A table of GetBindingExpression and UpdateSource results per way of setting Text. A literal, a MultiBinding and a TemplateBinding all yield null. OneTime and OneWay do nothing on an intact binding and raise InvalidOperationException once Text has been assigned. Typing through TextInput leaves the binding alive in every mode, with UpdateSource never called and the source unchanged." width="929" height="410" loading="lazy">
