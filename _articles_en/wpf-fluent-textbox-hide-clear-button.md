...
The rows with an implicit style deserve attention. Whichever route the theme arrives by, an implicit style under the same key makes `DeleteButton` disappear.
