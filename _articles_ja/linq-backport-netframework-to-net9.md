---
layout: article-ja
title: ".NET Framework の不足 LINQ メソッドを .NET 9 相当にバックポートする"
date: 2026-07-16
category: C#
...
.NET Framework から新世代 .NET（.NET 9 以降）への移行を段階的に進めている場合や、諸事情で .NET Framework 環境のコードをメンテナンスし続けなければならない場合、ストレスの原因となるのが「新世代 .NET にはあるのに、.NET Framework には存在しない LINQ メソッド」の存在である。
